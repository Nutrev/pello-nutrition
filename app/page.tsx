      ...
      <nav className="border-b border-sand bg-cream/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/query" className="text-sm text-muted hover:text-ink transition-colors">Query</Link>
            <Link href="/ingredients" className="text-sm text-muted hover:text-ink transition-colors">Ingredients</Link>
            <Link href="/graph" className="text-sm text-muted hover:text-ink transition-colors">Graph</Link>
        ...
        <div className="flex gap-12 items-start">
          ...
          <div className="hidden lg:flex flex-col gap-2 flex-shrink-0 pt-2 w-48">
            ...
            {[
              ...
              { href: "/graph", label: "Knowledge graph", desc: "Explore connections" },
            ].map((link) => (
